class ShopCatSeasonalModel:
    ...
    def fit(self, df):
        ...
        self.seasonality_df = (
            df.groupby(
                ['season', 'main_category', 'corrected_shop_id'],
                as_index=False
            )
            .agg(
    ...
    def predict(self, df):
        ...
        X = X.merge(
            self.seasonality_df[
                ...
                ['main_category', 'corrected_shop_id', 'seasonal_component']
            ],
        ...
        return (
            X['item_cnt_day'] - X['season_last'] + X['season_next']
        ).clip(lower=0)
